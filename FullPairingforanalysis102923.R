...
# Where are URIM applicants more likely to apply


# Look at difference in Percentage of URIM Applicants based on AUA section
...
# Link: logit
# yes/no
# exp()--- exponentiation of coefficients
# Can look at odds of atleast 1, 2, 3 URM for example
